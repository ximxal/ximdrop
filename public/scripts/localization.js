class Localization {
    ...
    static logHelpCall() {
        console.log("Help translating XimDrop: https://hosted.weblate.org/engage/ximdrop/");
    }
    ...
    static logHelpCallKey(key, attr) {
        ...
        console.warn(`Translate this string here: https://hosted.weblate.org/browse/ximdrop/ximdrop-spa/${locale}/?q=${keyComplete}`);
    }
